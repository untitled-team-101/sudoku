          ...
          <div className={"step1Containers"}>
            <div className={"step1Container1"}>
              <div className={"step1Para1"}>
                <p className={"para"}>
                  <div>
                    &#8226;Sudoku is played on a grid of 9 x 9 spaces. Within
                    the rows and columns are 9 “squares” (made up of 3 x 3
                    spaces).
                  </div>
                  <br />
                  <div>
                    &#8226;Each row, column and square (9 spaces each) needs to
                    be filled out with the numbers 1-9, without repeating any
                    numbers within the row, column or square.
                  </div>
                  <br />
                  <div>
                    &#8226;Does it sound complicated? As you can see from the
                    image below of an actual Sudoku grid, each Sudoku grid comes
                    with a few spaces already filled in; the more spaces filled
                    in, the easier the game – the more difficult Sudoku puzzles
                    have very few spaces that are already filled in.
                  </div>
                </p>
              </div>
